...
namespace COP2001
{
    internal partial class OldfrmReportAddCrit : System.Windows.Forms.Form
    {
        ...
        public void RefreshDestFieldList()
        {
            ...
            modGlobal.gv_sql = modGlobal.gv_sql + " where BaseTableID = " + Microsoft.VisualBasic.Compatibility.VB6.Support.GetItemData(frmReportSetupCopy.cboTableList, frmReportSetupCopy.cboTableList.SelectedIndex);
        ...
        private void frmReportAddCrit_Load(System.Object eventSender, System.EventArgs eventArgs)
        {
        ...
        public void AddCriteriaWithMethod1()
        {
            ...
            if (cboLookupValues.SelectedIndex > -1 & cboLookupValues.Visible == true)
            {
                ...
                //UPGRADE_WARNING: Couldn't resolve default property of object CritTitle. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                CritTitle = CritTitle + " " + cboLookupValues.Text;
        ...
        public void AddCriteriaWithMethod2old()
        {
            string CritTitle = null;
            int NewCritID;
            string field1type = null;
            object cboOpt2ValueOperator = null;


            //UPGRADE_WARNING: Couldn't resolve default property of object cboOpt2ValueOperator.ListIndex. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
            if (cboOpt2ValueOperator.ListIndex < 0)
            {
                RadMessageBox.Show("Please select the field operation from the list");
                return;
            }
            ...
            //UPGRADE_WARNING: Couldn't resolve default property of object cboOpt2ValueOperator.Text. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
            //UPGRADE_WARNING: Couldn't resolve default property of object CritTitle. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
            CritTitle = lstField1List.Text + " " + cboOpt2ValueOperator.Text + " " + Strings.Mid(cboLookupValues.Text, Strings.InStr(1, cboLookupValues.Text, "-") + 1);
