...
namespace COP2001
{
    public partial class frmReportCopySumCriteria : Telerik.WinControls.UI.RadForm
    {

        public frmReportCopySumCriteria()
        {
            InitializeComponent();
            ...
            try
            {
                ...
                else
                {
                    ...
                    modGlobal.gv_sql = string.Format("{0}{1}, ", modGlobal.gv_sql,
                        Support.GetItemData(frmReportSetupCopy.cboReportList, frmReportSetupCopy.cboReportList.SelectedIndex));
                    modGlobal.gv_sql = modGlobal.gv_sql + " CriteriaTitle, ";
                    modGlobal.gv_sql = modGlobal.gv_sql + " IndicatorID, ";
                    modGlobal.gv_sql = modGlobal.gv_sql + " Operator, ";
                    modGlobal.gv_sql = modGlobal.gv_sql + " MeasureID, ";
                    ...
                    modGlobal.gv_sql = string.Format("{0} where CriteriaID = {1}", modGlobal.gv_sql,
                        Support.GetItemData(frmReportSetupCopy.lstSelectedSumCriteria, frmReportSetupCopy.lstSelectedSumCriteria.SelectedIndex));
        ...
        private void frmReportCopySumCriteria_Load(object sender, EventArgs e)
        {
            this.CenterToParent();
            frmReportSetup frmReportSetupCopy = new frmReportSetup();
            ...
            try
            {
                ...
                const string sqlTableName1 = "tbl_setup_SavedAdhocReportSumCriteria";
        ...
        public void RefreshSetDef()
        {
            ...
            try
            {
                ...
                modGlobal.gv_sql = string.Format("{0} where Report_ID = {1}", modGlobal.gv_sql,
                    Support.GetItemData(frmReportSetupCopy.cboReportList, frmReportSetupCopy.cboReportList.SelectedIndex));
