...
namespace COP2001
{
	internal partial class OldfrmIndicatorAddToSet : System.Windows.Forms.Form
	{
		...
		private void cmdSelect_Click(System.Object eventSender, System.EventArgs eventArgs)
		{
			...
			for (i = 0; i <= lstIndicators.Items.Count - 1; i++) {
				if (lstIndicators.GetSelected(i)) {
					...
					newid = modDBSetup.FindMaxRecID(ref "tbl_Setup_IndicatorsetField", ref "IndLinkID");
					...
					modGlobal.gv_sql = modGlobal.gv_sql + "," + Microsoft.VisualBasic.Compatibility.VB6.Support.GetItemData(frmIndicatorSetupCopy.cboIndicatorSet, frmIndicatorSetupCopy.cboIndicatorSet.SelectedIndex);
		...
		private void frmIndicatorAddToSet_Load(System.Object eventSender, System.EventArgs eventArgs)
		{
		...
		public void RefreshIndicators()
		{
			...
			modGlobal.gv_sql = modGlobal.gv_sql + " where IndicatorSetID = " + Microsoft.VisualBasic.Compatibility.VB6.Support.GetItemData(frmIndicatorSetupCopy.cboIndicatorSet, frmIndicatorSetupCopy.cboIndicatorSet.SelectedIndex) + ")";
