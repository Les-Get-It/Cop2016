...
namespace COP2001
{
    internal partial class OldfrmReportCopyCriteria : System.Windows.Forms.Form
    {
        ...
        private void cmdCopy_Click(System.Object eventSender, System.EventArgs eventArgs)
        {
            ...
            else
            {
                ...
                modGlobal.gv_sql = modGlobal.gv_sql + " where CriteriaID = " + Microsoft.VisualBasic.Compatibility.VB6.Support.GetItemData(frmReportSetupCopy.lstSelectedCriteria, frmReportSetupCopy.lstSelectedCriteria.SelectedIndex);
        ...
        private void frmReportCopyCriteria_Load(System.Object eventSender, System.EventArgs eventArgs)
        {
