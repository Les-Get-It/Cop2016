...
namespace COP2001
{
    public partial class frmIndicatorAddDep : Telerik.WinControls.UI.RadForm
    {
        public frmIndicatorAddDep()
        {
            InitializeComponent();
        ...
        private void cmdSelect_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                for (i = 0; i <= lstIndicators.Items.Count - 1; i++)
                {
                    ...
                    {
                        newid = modDBSetup.FindMaxRecID("tbl_Setup_IndicatorDep", "IndicatorDepID");
                        ...
                        modGlobal.gv_sql = string.Format("{0},{1}", modGlobal.gv_sql, Support.GetItemData(frmIndicatorSetupCopy.lstIndicators, frmIndicatorSetupCopy.lstIndicators.SelectedIndex));
        ...
        private void frmIndicatorAddDep_Load(object sender, EventArgs e)
        {
            this.CenterToParent();
            try
            {
        ...
        public void refreshIndicators()
        {
            ...
            try
            {
                ...
                modGlobal.gv_sql = string.Format("{0} Where IndicatorID <> {1}", modGlobal.gv_sql, Support.GetItemData(frmIndicatorSetupCopy.lstIndicators, frmIndicatorSetupCopy.lstIndicators.SelectedIndex));
                ...
                modGlobal.gv_sql = string.Format("{0} where IndicatorParentID = {1}", modGlobal.gv_sql, Support.GetItemData(frmIndicatorSetupCopy.lstIndicators, frmIndicatorSetupCopy.lstIndicators.SelectedIndex));
